...
public class ScheduledThreadPoolExecutor
    ...
    private class ScheduledFutureTask<V>
         ...
         */
        //覆盖FutureTask的run版本方法，用来执行周期性的任务
        public void run() {
            if (isPeriodic())
                runPeriodic();
            else
     ...
     */
    //ThreadPoolExecutor.execute方法的特殊变种
    ...
    public ScheduledFuture<?> schedule(Runnable command,
        ...
        //把Runnable转换为RunnableScheduledFuture
